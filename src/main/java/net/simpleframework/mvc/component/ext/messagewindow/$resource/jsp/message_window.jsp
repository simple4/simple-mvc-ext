...
<%
	final ComponentParameter nComponentParameter = MessageWindowUtils.get(request, response);
	final IMessageWindowHandle mh = (IMessageWindowHandle) nComponentParameter
	.getComponentHandler();
	if (mh == null) {
		return;
	}
